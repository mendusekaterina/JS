...
for (i = 0; i < 11; i++) {
    document.write(`<div class="cube"><h4>block</h4></div>`);
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині

for (i = 0; i < 11; i++) {
    document.write(`<div><h4>block_with ${i} index </h4></div>`);
}

// - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом всередині.
let h = 0;
while (h < 21) {
    document.write(`<h1>while_blocks</h1>`);
    h++;
}
...
let x = 0;
while (x < 21) {
    document.write(`<h1>while_blocks_with ${x} index</h1>`);
    x++;
}
